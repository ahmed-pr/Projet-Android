...
public class ListeVaccins extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        for(Vaccination c : d.listeCitoyenVaccin()) {
            ...
            ((Button) r.getChildAt(1)).setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(ListeVaccins.this, ValiderVaccination.class);
