...
public class ListeDemandes extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        for(CitizenRequest c : d.listeDemande()) {
            ...
            ((Button) r.getChildAt(1)).setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(ListeDemandes.this, Demande.class);
                    intent.putExtra("message", c);
                    startActivity(intent);
                }
            } ) ;
